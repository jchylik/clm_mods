...
contains
  ...
  subroutine CBalanceCheck(this, bounds, num_soilc, filter_soilc, &
    ...
    associate(                                                                            & 
         ...
         beccs_harvestc          =>    cnveg_carbonflux_inst%beccsc_to_prodseqc_col     , & ! Input:  [real(r8) (:) ]  (gC/m2/s) beccs harvest (to sequestred product pool)
      ...
      if (err_found) then
         ...
         write(iulog,*)'beccs_harvestc           = ',beccs_harvestc(c)*dt
