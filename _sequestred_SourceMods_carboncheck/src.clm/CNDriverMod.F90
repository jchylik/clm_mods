...
contains
  ...
  subroutine CNDriverNoLeaching(bounds,                                                    &
    ...
    call c_products_inst%UpdateProducts(bounds, &
         ...
         ocrop_to_cropprod_patch = cnveg_carbonflux_inst%beccsc_to_prodseqc_patch(begp:endp))
    ...
    if (use_c13) then
       call c13_products_inst%UpdateProducts(bounds, &
            ...
            ocrop_to_cropprod_patch = c13_cnveg_carbonflux_inst%beccsc_to_prodseqc_patch(begp:endp))
    end if
    ...
    if (use_c14) then
       call c14_products_inst%UpdateProducts(bounds, &
            ...
            ocrop_to_cropprod_patch = c14_cnveg_carbonflux_inst%beccsc_to_prodseqc_patch(begp:endp))
    end if
    ...
    call n_products_inst%UpdateProducts(bounds, &
         ...
         ocrop_to_cropprod_patch = cnveg_nitrogenflux_inst%beccsn_to_prodseqn_patch(begp:endp))
