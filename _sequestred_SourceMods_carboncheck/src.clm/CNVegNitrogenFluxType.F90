module CNVegNitrogenFluxType
  ...
  type, public :: cnveg_nitrogenflux_type
     ...
     real(r8), pointer :: beccsn_to_prodseqn_patch                  (:)     ! patch beccs N to sequestered product pool (gN/m2/s)
     real(r8), pointer :: beccsn_to_prodseqn_col                    (:)     ! col beccs N to sequestered product pool (gN/m2/s)     
     ...
     real(r8), pointer :: leafn_to_beccsn_patch                     (:)     ! patch leaf N to beccs N (gN/m2/s)
     real(r8), pointer :: livestemn_to_beccsn_patch                 (:)     ! patch livestem N to beccs N (gN/m2/s)     
...
contains
  ...
  subroutine InitAllocate(this, bounds)
    ...
    allocate(this%leafn_to_beccsn_patch                     (begp:endp)) ; this%leafn_to_beccsn_patch                     (:) = nan
    allocate(this%livestemn_to_beccsn_patch                 (begp:endp)) ; this%livestemn_to_beccsn_patch                 (:) = nan    
    ...
    allocate(this%beccsn_to_prodseqn_patch                  (begp:endp)) ; this%beccsn_to_prodseqn_patch                  (:) = nan
    allocate(this%beccsn_to_prodseqn_col                    (begc:endc)) ; this%beccsn_to_prodseqn_col                    (:) = nan
...
! End BACKWARDS_COMPATIBILITY(wrw, 2018-06-28) re. issue #426
  ...
  subroutine SetValues ( this, &
    ...
    do fi = 1,num_patch
       ...
       this%beccsn_to_prodseqn_patch(i)                  = value_patch
    end do
    ...
    if ( use_crop )then
       do fi = 1,num_patch
          ...
          this%leafn_to_beccsn_patch(i)                  = value_patch
          this%livestemn_to_beccsn_patch(i)              = value_patch          
    ...
    do fi = 1,num_column
       ...
       this%beccsn_to_prodseqn_patch(i)      = value_column
